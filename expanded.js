...
// by Ekenmer
// working Demo: https://repl.it/EAO8
...
/* Function that calculates the % (rounded to two decimal places) of every result in relationship to 
...
/* Start of the main loop that will run as long as theres no 5 same numbers in the throw (ends at the 
...
/* This will increments by 1 every time a number appears (the results, maximum possible value of any 

index position is 5) */
resultsArray = [0,0,0,0,0,0];

/* Sums +1 for evey resulting number in his own resultsArray index position, so we can track how many 

dices of each number are in the current throw (the counter) */
...
/* Run all the game logic while we dont get a number 5 in largestAmount (5 equal numbered dices), 

this conditional starts at line 22 */
